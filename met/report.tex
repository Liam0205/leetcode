...
\begin{question}
给你一个长度为 \lstinline[style = lcpp]|n| 的向量，实现随机选择函数 \lstinline[style = lcpp]|random_choice|，从中随机选择 \lstinline[style = lcpp]|k| 个元素。
\end{question}
\begin{solution}
关键点：
\begin{compactitem}
    ...
    \item 线性复杂度。
\end{compactitem}
\lstinputlisting[style = lcpp]{random_choice.cc}
\end{solution}
